...
pub use protocol::contracts::{
    ...
    ChatResponse, ContextBlock, KnowledgeOutcome, LocalStateEffect, ProposedClaimDto,
    ProviderError, SuppliedClaimDto, SuppliedContractDto, ToolCall, ToolDefinition, ToolEffect,
    ToolError, ToolExecutor, ToolMetadata,
};
